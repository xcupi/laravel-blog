...
<head>
    ...
    <title>Tambah Data Post - ITTS</title>
...
<body style="background: lightgray">
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <button type="reset" class="btn btn-md btn-warning" id="resetBtn">RESET</button>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Simpan nilai awal konten CKEditor
            var initialContent = CKEDITOR.instances['content'].getData();

            // Tambahkan event listener pada tombol reset
            document.querySelector('#resetBtn').addEventListener('click', function () {
                // Kembalikan nilai konten CKEditor ke nilai awal
